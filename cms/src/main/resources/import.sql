INSERT INTO entry(id, title, content) VALUES (nextval('entry_seq'), 'Getting Started with Quarkus', '
...
INSERT INTO entry(id, title, content) VALUES (nextval('entry_seq'), 'Web Components with Lit', '
...
INSERT INTO entry(id, title, content) VALUES (nextval('entry_seq'), 'Exploring HTMX', '
### Introduction
